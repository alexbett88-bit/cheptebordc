        ...
        <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between relative">
          ...
          >
            ...
            <div className="hidden lg:block border-l border-emerald-100 pl-4">
              <h1 className="font-serif font-bold text-xl tracking-tight text-cheptebo-green leading-none">A.I.C CHEPTEBO</h1>
              <span className="text-[8px] uppercase tracking-[0.3em] font-bold text-emerald-600">Rural Development Centre</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-8">
            <div className="flex flex-col items-start gap-4">
              ...
              <h2 className="font-serif font-bold text-2xl tracking-tight text-white">A.I.C CHEPTEBO</h2>
            </div>
